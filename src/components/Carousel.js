...
import Logo1 from '../images/acceuil.jpg';
const Carousel = () => {
  return (
...
<div id="carouselExampleCaptions" name='PROJETS' className="carousel slide carousel-fade relative" data-bs-ride="carousel">
  ...
  <div className="carousel-inner relative w-full overflow-hidden">
    <div className="carousel-item active relative float-left w-full">
      <img className='w-full block h-' src={Logo} />
      <div className="carousel-caption hidden md:block absolute text-center bg-green01">
